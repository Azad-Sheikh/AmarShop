<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="AddQuantity.aspx.cs" Inherits="AmarShop.Admin.AddQuantity" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-3">
                <p></p>
                <asp:Button ID="btnAddQuantity" CssClass="btn btn-success" runat="server" Text="ADD" OnClick="btnAddQuantity_Click" />
                <p></p>
            </div>
        </div>
